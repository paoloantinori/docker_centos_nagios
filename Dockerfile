...
ADD https://anorien.csc.warwick.ac.uk/mirrors/epel/6/i386/epel-release-6-8.noarch.rpm /root/
RUN yum localinstall /root/epel-release-6-8.noarch.rpm
RUN yum -y install httpd php gcc glibc glibc-common gd gd-devel
...
ADD http://www.waggy.at/nagios/capture_plugin.txt /etc/nagios
RUN mv /etc/nagios/capture_plugin.txt /etc/nagios/capture_plugin.pl
